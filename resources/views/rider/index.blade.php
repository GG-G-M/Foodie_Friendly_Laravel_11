    ...
    @if($currentOrder)
        <div class="card shadow mb-4" style="border-radius: 12px; background-color: #fefaf3;">
            ...
            <div class="card-body">
                ...
                <p><strong>Delivery Address:</strong> {{ $currentOrder->delivery_address ?? 'Not specified' }}</p>
                <p><strong>Payment Method:</strong> {{ $currentOrder->payment_method ?? 'Not specified' }}</p>
