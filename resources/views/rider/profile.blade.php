@extends('layouts.rider') {{-- This links to the layout file in resources/views/layouts/rider.blade.php --}}
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-lg" style="border-radius: 15px; overflow: hidden;">
                ...
                <div class="card-body" style="background-color: #F5F5DC;">
                    ...
                    <!-- Edit Form -->
                    <form action="{{ route('profile.update') }}" method="POST" hx-post="{{ route('profile.update') }}" hx-target="#profile-update-message" hx-swap="outerHTML">
                        @csrf
                    ...
                    <!-- Display the success/error message here after form submission -->
